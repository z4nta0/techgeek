...
/** cliCouObjSlice = Click Count Object Slice will use Redux Toolkit's core API that automatically generates action creators and reducers for a single slice of application's state. It returns a single object that contains the slice name, generated reducer, its corresponding actions, case reducers, and an optional getSelectors function. */
export const cliCouObjSlice = createSlice( sliOptObj );

/** This exports the reducer functions that were generated by the above {@link cliCouObjSlice} and that were defined in the {@link sliOptObj} object's reducers property. */
...
/** This exports the reducer function that was generated by the above {@link cliCouObjSlice} and that was defined in the {@link sliOptObj} object's reducers property, and it is what will get imported into the Redux store inside of src/store.tsx. */
export default cliCouObjSlice.reducer;
